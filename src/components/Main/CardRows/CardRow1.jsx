...
let cardInfo = [
    ...
    {img: card_2, name: "BUTTER", version: "", group: "BTS", price: "От 2 250 р"},
    {img: card_3, name: "THE WORLD EP.FIN: WILL", version: "STANDART", group: "ATEEZ", price: "От 2 400 р"},
    {img: card_4, name: "SKZHOP HIPTAPE '合 (HOP)'", version: "HIPTAPE", group: "STRAY KIDS", price: "2 300 р"},
]
