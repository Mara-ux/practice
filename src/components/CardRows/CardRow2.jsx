    ...
    return (
        <section className={s.hitsection}>
            ...
            <div className={s.cardRow}>
                ...
                <Card img={card_2} name="DESIRE : UNLEASH" version="ENGENE" group="ENHYPEN" price="От 1 350 р" />
                <Card img={card_3} name="DESIRE : UNLEASH" version="Weverse" group="ENHYPEN" price="900 р" />
                <Card img={card_4} name="BEEP" version="(QR Album Ver.)" group="izna" price="3 500 р" />
            </div>
        </section>
    );
}
